...
namespace bank_api.Migrations
{
    ...
    [Migration("20230411062051_SixthMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bank_api.Models.AccountType", b =>
                {
                    b.Property<long>("AccountTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("AccountTypeId"));
            ...
            modelBuilder.Entity("Account", b =>
                {
                    b.HasOne("bank_api.Models.AccountType", "AccountType")
                        .WithMany("Accounts")
                        .HasForeignKey("AccountTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("bank_api.Models.Client", "Client")
                        .WithMany("Accounts")
